     ...
     <meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <style>
		...
		.demo-card-wide > .mdl-card__title {
		  color: #fff;
		  height: 300px;
		  background: url('../images/fall_silhouettesvg.svg') center / cover;
		}
	...
	<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600 mdl-layout--large-screen-only">
        <div class="demo-card-wide mdl-card mdl-shadow--2dp" style="width: 100%">
		  <div class="mdl-card__title">
		    <h2 class="mdl-card__title-text" style="color: #E0E0E0;">Welcome</h2>
		  </div>
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          <a class="mdl-navigation__link" href="" style="background-color: #E0E0E0;"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">home</i>Home</a>
