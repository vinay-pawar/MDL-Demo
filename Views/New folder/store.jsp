	...
	<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" style="background-color: #E0E0E0;"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">file_upload</i>Upload</a>
          <a class="mdl-navigation__link" href="security.html"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">verified_user</i>Security</a>
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid" id="con">
          ...
          <div class="mdl-cell mdl-cell--4-col graybox">
            <div class="demo-card-wide mdl-card mdl-shadow--2dp mdl-card__title">
              <div class="mdl-card__title">
                <form action="uploadjsp.jsp" id="uploadform" method="post" enctype="multipart/form-data">
                    <script type="text/javascript">
                    	function clickip(){
                    		var ip=document.getElementById("ipfile");
                    		ip.click();
                    	};
                    	function clickfl(){
                    		var str=document.getElementById("ipfile").value;
                    		var lb=document.getElementById("labl");
                    		var pieces = str.split('\\');
							var filename = pieces[pieces.length-1];
                    		lb.innerHTML=filename;
                    	};
                    </script>
                    <input type="file" id="ipfile" name="ipfile" style="visibility: hidden;" onchange ="clickfl()"></input>
                    <div style="text-align: center;" onclick="clickip()"><a style="cursor: pointer;"><i class="material-icons" role="presentation" style="font-size: 12em">cloud_upload</i></a></div>
                    <div style="text-align: center;" onclick="clickip()"><a style="cursor: pointer;" id="labl">Choose Files...</a></div>
                    <div style="text-align: center;" onclick=""><a style="cursor: pointer;"><h3>Upload</h3></a></div>
                </form>
              </div>
            </div>
          </div>
